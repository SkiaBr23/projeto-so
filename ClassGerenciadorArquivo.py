...
class ClassGerenciadorArquivo:
	...
	@staticmethod
	def inserirInicioDisco(vetor_arquivos_disco, posicoesDisco):
	...
	#
	@staticmethod
	def inserirArquivoDisco(arquivo, vetor_arquivos_disco, posicoesDisco):
	...
	@staticmethod
	def deletarArquivoDisco(arquivo, vetor_arquivos_disco, posicoesDisco):
